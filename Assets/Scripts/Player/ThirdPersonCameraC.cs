...
public class ThirdPersonCameraC : MonoBehaviour {
    ...
    private ThirdPersonControllerC controller;
    ...
    void Awake ()
    {
    	...
    	if (_target)
    	{
    		controller = _target.GetComponent<ThirdPersonControllerC>();
    	}
    ...
    void Apply (Transform dummyTarget, Vector3 dummyCenter)
    {
    	...
    	if (snap)
    	{
    		...
    		if (AngleDistance (currentAngle, originalTargetAngle) < 3)
    			snap = false;
